...
def webhook():
    ...
    if action == 'flips':
        ...
        res = takeoff(req)
    elif action == 'takeoff_move':
        res = takeoff_move(req)
    elif action == 'circle':
        res = circle(req)
